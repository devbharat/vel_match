...
static void calc_throttle()
{
    ...
    if (!alt_control_airspeed()) {
        ...
        */
        ...
        energy_error = airspeed_energy_error + altitude_error_cm * 0.098f;//btak
        
        // btak - add error similar to energy_error based on distance from next waypoint
        // error  = k*(get_distance(current_loc - next_target_loc))
        // or atleast maintain gps_cruise_velocity = 17 m/s for example.
        
        // Trial, maintain gps velocity at 17 m/s 
