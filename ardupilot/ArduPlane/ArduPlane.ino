...
flock_member flockmember1(1);
flock_member flockmember2(2);
...
static void slow_loop()
{
    ...
    //This part contains all cooperative mission part:Btak
            ...
            XBee_sendFollower(1,&current_loc, 0, g_gps);
        #endif
...
{
//btak_dbg_remove_later
    /*    
    hal.uartC->printf("latitude");
    char buffer[20] = "somevalue";     
    sprintf(buffer,"%l",dbg_lat);
        
    hal.uartC->printf(buffer);
    */    
